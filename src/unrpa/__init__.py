...
class UnRPA:
    ...
    def list_files(self) -> None:
        ...
        for path in sorted(paths):
            print(path)
        return paths # i added this so we can get the list of files ourselves
    ...
    def extract_file(
        ...
        self.update_status(name, file_number, total_files)
        self.update_progress(file_number, total_files)
