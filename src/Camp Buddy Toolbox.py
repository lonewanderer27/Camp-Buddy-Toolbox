...
debug_mode = True
sg.theme('DarkBrown3')  # put this here before using sg !!!
...
master_layout = [
    ...
    [sg.ProgressBar(max_value=100, orientation='horizontal', expand_x=True, key='-progress_bar-', size=(20, 20))],
    [sg.Text('Status:'), sg.Text('Idle', key='-current_status-', size=(75, None), auto_size_text=True)],
]

window = sg.Window(title=title, layout=master_layout)
ea_mode = True
